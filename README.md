...
- Java (Worked on various layers of terminal abstraction via the [Tetrue Terminal](https://github.com/BFUR64/tetrue-terminal) and [Tetrue](https://github.com/BFUR64/tetrue-lite) projects)
- JavaScript/React (Various web development explorations like [Handa360](https://github.com/BFUR64/handa360))

### Tools

- Linux (I have a personal homelab infrastructure + VPS for CGNAT (thank you tailscale for peer-relay)!)
- Git, GitHub
- Gradle
- Docker Compose

## Feel free to reach out!
- Email: [iterranceevan@gmail.com](mailto:iterranceevan@gmail.com)
